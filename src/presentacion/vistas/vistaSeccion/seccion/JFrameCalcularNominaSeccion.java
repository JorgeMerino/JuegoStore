...
public class JFrameCalcularNominaSeccion extends JFrame {
	private static final long serialVersionUID = 1L;
	private JTextField id;
	private JButton enviar;
	private JButton salir;
	
	public JFrameCalcularNominaSeccion() {
		Dimension pantalla = Toolkit.getDefaultToolkit().getScreenSize();
		
		this.setTitle("Calcular nomina seccion");
	...
	public class ActionListenerBajaCliente implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			try {
				Controlador.getInstance().accion(ListaComandos.NEGOCIO_CALCULAR_NOMINA_SECCION, Integer.parseInt(id.getText()));
			} 
