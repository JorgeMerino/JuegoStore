...
public class JFrameDetalleSeccion extends JFrame {
	...
	public JFrameDetalleSeccion() {
		Dimension pantalla = Toolkit.getDefaultToolkit().getScreenSize();
		
		this.setTitle("Detalle seccion");
	...
	public class ActionListenerDetalleCliente implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			try {
				Controlador.getInstance().accion(ListaComandos.NEGOCIO_DETALLE_SECCION, Integer.parseInt(id.getText()));
			} 
