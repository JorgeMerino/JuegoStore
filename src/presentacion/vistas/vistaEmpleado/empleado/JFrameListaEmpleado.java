...
public class JFrameListaEmpleado extends JFrame {
	...
	public JFrameListaEmpleado() {
		...
		enviar.addActionListener(new ActionListenerListaEmpleado());
	...
	public class ActionListenerListaEmpleado implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent arg0) {
			Controlador.getInstance().accion(ListaComandos.NEGOCIO_LISTA_EMPLEADO, null);
		}
	}
