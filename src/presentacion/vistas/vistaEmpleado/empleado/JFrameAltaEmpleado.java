...
public class JFrameAltaEmpleado extends JFrame {
	...
	public JFrameAltaEmpleado() {
		...
		enviar.addActionListener(new ActionListenerAltaEmpleado());
	...
	public class ActionListenerAltaEmpleado implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent arg0) {
			try {
				TransferEmpleado t = null;
		        if (tipo.getSelectedIndex() == 0) 
		        	t = new TransferDependiente(nombre.getText(), dni.getText(), Integer.parseInt(telefono.getText()), Double.parseDouble(sueldo.getText()), Integer.parseInt(seccion.getText()), true, Integer.parseInt(especifico1.getText()), Integer.parseInt(especifico2.getText()));
		        else
		        	t = new TransferEspecialista(nombre.getText(), dni.getText(), Integer.parseInt(telefono.getText()), Double.parseDouble(sueldo.getText()), Integer.parseInt(seccion.getText()), true, especifico1.getText(), Double.parseDouble(especifico2.getText()));			
		        
		        Controlador.getInstance().accion(ListaComandos.NEGOCIO_ALTA_EMPLEADO, t);
			} 
