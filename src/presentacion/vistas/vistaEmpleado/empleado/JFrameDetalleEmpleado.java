...
public class JFrameDetalleEmpleado extends JFrame {
	...
	public JFrameDetalleEmpleado() {
		Dimension pantalla = Toolkit.getDefaultToolkit().getScreenSize();
		this.setTitle("Detalle empleado");
		...
		enviar.addActionListener(new ActionListenerDetalleEmpleado());
	...
	public class ActionListenerDetalleEmpleado implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent arg0) {
			try {
				Controlador.getInstance().accion(ListaComandos.NEGOCIO_DETALLE_EMPLEADO, Integer.parseInt(id.getText()));
			}
